...
public class CardsThirdTierAdapter extends RecyclerView.Adapter<CardsThirdTierAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public CardsThirdTierAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
