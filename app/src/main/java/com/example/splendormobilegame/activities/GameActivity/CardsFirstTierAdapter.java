...
public class CardsFirstTierAdapter extends RecyclerView.Adapter<CardsFirstTierAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public CardsFirstTierAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
